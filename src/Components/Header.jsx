			...
			*/}
			...
			<div className="flex items-center gap-3 mr-2">
				...
				(<Menu as="div" className="relative">
					...
					<button  className='border-2 py-1 px-2 md:px-3 text-base md:text-lg rounded-md drop-shadow-3xl text-neutral-800 tracking-normal bg-slate-100 --tw-shadow-color: #f1f5f9; hover:bg-red-600 hover:text-white font-semibold ' onClick={() => loginWithRedirect()}>Sign Up</button>
					)}
